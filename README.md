...
This was tested on Ubuntu 16.04 and Solus. It was compiled on a 64-bit system, so it will likely only run on a 64-bit system. I will look into adding 32-bit components.
